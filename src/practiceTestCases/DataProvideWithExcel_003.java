...
import Utility.ExcelUtilsDemo;

public class DataProvideWithExcel_003 {
		...
		@Test(dataProvider = "newAuth")
		public void registerNew(String sUserName,String sPassword)
		{
		...
		@DataProvider
		public Object[][] newAuth() throws IOException
		{
			Object[][] valueObjects =ExcelUtilsDemo.DataMethod("C://Users//Abhirema//eclipse-workspace//TestNGProject1//src//testData//TestData.xlsx","Sheet1");
			return (valueObjects);
		}
		@AfterMethod
